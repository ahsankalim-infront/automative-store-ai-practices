...
export const DEFAULT_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    mobileCta: "Shop Now",
    description:
      "Top premium quality leather PU & PVC fabric seat covers. Custom fit for 200+ models with diamond stitching and expert fitting at our Lahore studio.",
  ...
  },
  {
    ...
    description:
      "Heavy-duty waterproof car top covers with UV-resistant coating. Universal and premium fitted options to protect your vehicle outdoors.",
    ctaLabel: "Shop Top Covers",
    ctaHref: "/products?category=car-top-cover",
    secondaryLabel: "View Collection",
    secondaryHref: "/products?category=car-top-cover",
    productImage: SIGNATURE_IMAGES_HERO.topCover,
    productLabel: "Waterproof Top Cover",
    productPrice: "From Rs. 6,500",
    badgeIcon: "Umbrella",
    badgeText: "UV Protected",
    stat1Value: "100%",
    stat1Label: "Waterproof",
    stat2Value: "UV",
    stat2Label: "Resistant",
    stat3Value: "6 Mo",
    stat3Label: "Warranty",
  ...
  },
  {
    ...
    mobileCta: "Shop Mats",
    description:
      "Precision-cut floor matting for every car model. High-wall design traps dirt and spills. Odourless, waterproof and easy to clean.",
    ctaLabel: "Shop Floor Matting",
    ctaHref: "/products?category=car-floor-matting",
    secondaryLabel: "Book Fitting",
    secondaryHref: "/services/book",
  ...
  },
  {
    ...
    description:
      "Premium fitted car top covers with soft inner lining, mirror pockets and double-stitched seams. Complete protection without scratching your paint.",
    ctaLabel: "Shop Premium Line",
    ctaHref: "/products?category=car-top-cover",
...
export function resolveHeroSlideTag(tag: string, shortName: string): string {
  return tag.replace(/\{shortName\}/g, shortName);
}
